package com.adriano.clinical.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket Api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.adriano.clinical"))
                .paths(PathSelectors.any()).build()
                .apiInfo(apiInfo());
    }

    private ApiInfo apiInfo() {
        return new ApiInfo("Rest API para Consultório médico", "Plataforma para consultórios ", "v1",
